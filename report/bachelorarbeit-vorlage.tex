...
% die folgenden Packete erlauben den Gebrauch von Umlauten und Ã
% in der Latex Datei
...
%Beispielhaft sollen an dieser Stelle mehrere baden-württembergische Städte zunächst mit Hilfe des entwickelten Programms analysiert und anschließend verglichen werden.
