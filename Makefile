...
traffic-karlsruhe:
	$(run_get_traffic) --lat 49.0068900 --lng 8.4036530 --zoom 17 --tiles 3 --show_grid_image

traffic-berlin:
	$(run_get_traffic) --lat 52.517148 --lng 13.393632 --zoom 14 --tiles 3 --show_grid_image
...
all-traffic-snapshot:
	$(run_get_traffic) --lat 49.0068900 --lng 8.4036530 --zoom 17 --tiles 1
	$(run_get_traffic) --lat 52.5171480 --lng 13.3936320 --zoom 14 --tiles 1
	$(run_get_traffic) --lat 37.7532400 --lng -122.4473590 --zoom 15 --tiles 1
	$(run_get_traffic) --lat 31.2243220 --lng 121.4691240 --zoom 17 --tiles 1
	$(run_get_traffic) --lat 48.7775610 --lng 9.1785610 --zoom 14 --tiles 1
	$(run_get_traffic) --lat 47.9938040 --lng 7.8325110 --zoom 15 --tiles 1
